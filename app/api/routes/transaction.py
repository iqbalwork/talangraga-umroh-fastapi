...
from app.schemas.transaction import TransactionOut, TransactionUpdateStatus
...
# 🟢 CREATE Transaction (Form Data & File Upload)
...
def create_transaction(
    ...
    if file:
        ...
        # Generate custom or unique safe filename
        timestamp = int(datetime.utcnow().timestamp())
        safe_filename = file.filename or f"{current_user.id}_{timestamp}_transaction.jpg"
        ...
        # Relative path/URL for the client to access
        bukti_transfer_url = f"/static/uploads/{safe_filename}"
